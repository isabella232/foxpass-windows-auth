namespace pGina.Plugin.Ldap
{
    partial class Configuration
    {
        ...
        private void InitializeComponent()
        {
			...
			this.validateServerCertCheckBox.Location = new System.Drawing.Point(509, 207);
			...
			this.validateServerCertCheckBox.Visible = false;
        ...
        "s certificate store.");
			...
			// ldapPortTextBox
			// 
			this.ldapPortTextBox.Location = new System.Drawing.Point(107, 205);
			...
			this.ldapPortTextBox.Visible = false;
			// 
			// ldapPortLabel
			// 
			this.ldapPortLabel.AutoSize = true;
			this.ldapPortLabel.Location = new System.Drawing.Point(3, 208);
			...
			this.ldapPortLabel.Visible = false;
			// 
			// useSslCheckBox
			// 
			this.useSslCheckBox.AutoSize = true;
			this.useSslCheckBox.Location = new System.Drawing.Point(360, 207);
        ...
        "this is left blank, an anonymous\r\nbind will be attempted.");
			...
			this.label3.Text = "Binder Password";
			this.descriptionToolTip.SetToolTip(this.label3, "The password to use when searching");
			// 
			// timeoutLabel
			// 
			this.timeoutLabel.AutoSize = true;
			this.timeoutLabel.Location = new System.Drawing.Point(203, 208);
        ...
        "ng on to the next server.");
			...
			// timeoutTextBox
			// 
			this.timeoutTextBox.Location = new System.Drawing.Point(262, 205);
        ...
        "succeeds if this is checked. ");
			...
			// sslCertFileTextBox
			// 
			this.sslCertFileTextBox.Location = new System.Drawing.Point(106, 231);
			...
			this.descriptionToolTip.SetToolTip(this.sslCertFileTextBox, "Optional:  If left empty, the certificate will be validated against the Local Com" +
        "puter certificate store.\r\nPut in MATCH if you have stored the certificate in the" +
        " Local Computer certification storage.");
			this.sslCertFileTextBox.Visible = false;
			// 
			// allowEmptyPwCB
			// 
        ...
        "ove pattern.");
			...
			this.useTlsCheckBox.Location = new System.Drawing.Point(434, 207);
        ...
        "ption\nYou can run encryption and clear text over 389");
			...
			this.sslCertFileBrowseButton.Visible = false;
			...
			this.useAuthBindForAuthzAndGatewayCb.Visible = false;
			...
			this.tabControl1.Location = new System.Drawing.Point(390, 205);
			this.tabControl1.Name = "tabControl1";
			this.tabControl1.SelectedIndex = 0;
			this.tabControl1.Size = new System.Drawing.Size(197, 30);
			...
			this.authTabPage.Size = new System.Drawing.Size(189, 4);
			...
			this.authzTabPage.Size = new System.Drawing.Size(189, 4);
			...
			this.gatewayTabPage.Size = new System.Drawing.Size(189, 4);
			...
			this.tabPageChangePassword.Size = new System.Drawing.Size(189, 4);
			...
			this.Controls.Add(this.validateServerCertCheckBox);
