namespace pGina.Configuration
{
    partial class ConfigurationUI
    {
        ...
        private void InitializeComponent()
        {
			...
			this.Configure_Ldap = new System.Windows.Forms.Button();
			...
			this.m_generalConfigTab.Controls.Add(this.m_tileImagePreview);
			...
			this.m_generalConfigTab.Size = new System.Drawing.Size(274, 327);
			...
			// Configure_Ldap
			// 
			this.Configure_Ldap.Location = new System.Drawing.Point(70, 266);
			...
			this.ntpservers_group.Location = new System.Drawing.Point(623, 299);
			this.ntpservers_group.Name = "ntpservers_group";
			this.ntpservers_group.Size = new System.Drawing.Size(143, 106);
			this.ntpservers_group.TabIndex = 4;
			this.ntpservers_group.TabStop = false;
			this.ntpservers_group.Text = "NTP Servers";
			this.ntpservers_group.Visible = false;
			// 
			// ntpservers
			// 
			this.ntpservers.Location = new System.Drawing.Point(66, 19);
			this.ntpservers.Name = "ntpservers";
			this.ntpservers.Size = new System.Drawing.Size(122, 81);
			this.ntpservers.TabIndex = 0;
			this.ntpservers.Text = "";
			this.ntpservers.Visible = false;
			...
			this.chk_preferlocalauthentication.Visible = false;
			// 
			// chk_lastusername
			// 
			...
			this.chk_lastusername.Visible = false;
			// 
			// groupBox18
			// 
			...
			this.notify_label_pass.Visible = false;
			// 
			// notify_label_user
			// 
			...
			this.notify_label_user.Visible = false;
			// 
			// notify_label_email
			// 
			...
			this.notify_label_smtp.Visible = false;
			// 
			// notify_ssl
			// 
			...
			this.notify_cred.Visible = false;
			// 
			// notify_pass
			// 
			...
			this.notify_pass.Visible = false;
			// 
			// notify_user
			// 
			...
			this.notify_user.Visible = false;
			// 
			// notify_email
			// 
			...
			this.notify_email.Visible = false;
			// 
			// notify_smtp
			// 
			...
			this.notify_smtp.Visible = false;
			// 
			// groupBox4
			// 
			...
			this.chk_originalUsernameUnlock.Visible = false;
			// 
			// groupBox14
			// 
			...
			this.groupBox14.Location = new System.Drawing.Point(407, 299);
			this.groupBox14.Name = "groupBox14";
			this.groupBox14.Size = new System.Drawing.Size(153, 106);
			...
			this.cpEnableDisableBtn.Visible = false;
			...
			this.cpRegisterBtn.Visible = false;
			...
			this.cpEnabledTB.Visible = false;
			// 
			// cpEnabledLabel
			// 
			...
			this.cpEnabledLabel.Visible = false;
			// 
			// cpRegisteredTB
			// 
			...
			this.cpRegisteredTB.Visible = false;
			// 
			// label13
			// 
			...
			this.servGB.Location = new System.Drawing.Point(17, 123);
			this.servGB.Name = "servGB";
			this.servGB.Size = new System.Drawing.Size(236, 117);
			this.servGB.TabIndex = 2;
			this.servGB.TabStop = false;
			this.servGB.Text = "Foxpass Windows Auth Service";
			// 
			...
			this.motdGB.Location = new System.Drawing.Point(396, 182);
			this.motdGB.Name = "motdGB";
			this.motdGB.Size = new System.Drawing.Size(370, 108);
			this.motdGB.TabIndex = 1;
			this.motdGB.TabStop = false;
			this.motdGB.Text = "MOTD";
			this.motdGB.Visible = false;
			// 
			// enableMotdCB
			// 
			...
			this.enableMotdCB.Visible = false;
			...
			this.groupBox12.Location = new System.Drawing.Point(384, 138);
			this.groupBox12.Name = "groupBox12";
			this.groupBox12.Size = new System.Drawing.Size(382, 160);
			...
			// btnImageBrowse
			// 
			this.btnImageBrowse.Location = new System.Drawing.Point(457, 143);
			...
			this.btnImageBrowse.Visible = false;
			this.btnImageBrowse.Click += new System.EventHandler(this.btnImageBrowse_Click);
			// 
			// label11
			// 
			this.label11.AutoSize = true;
			this.label11.Location = new System.Drawing.Point(537, 189);
			...
			// m_tileImageTxt
			// 
			this.m_tileImageTxt.Location = new System.Drawing.Point(94, 145);
			...
			this.m_tileImageTxt.Visible = false;
			// 
			// label10
			// 
			...
			this.m_tileImagePreview.Location = new System.Drawing.Point(17, 7);
			this.m_tileImagePreview.Name = "m_tileImagePreview";
			this.m_tileImagePreview.Size = new System.Drawing.Size(236, 110);
			...
			this.ginaOptions.Size = new System.Drawing.Size(274, 327);
    ...
    "above.";
			...
			this.btnApply.Location = new System.Drawing.Point(215, 380);
			...
			this.btnOkay.Location = new System.Drawing.Point(16, 380);
			...
			this.m_pginaVersionLbl.Location = new System.Drawing.Point(17, 404);
			...
			this.btnSaveAndClose.Location = new System.Drawing.Point(115, 380);
			...
			this.help.Location = new System.Drawing.Point(-24, 399);
			this.help.Name = "help";
			...
			this.Text = "Foxpass Windows Auth";
		...
		private System.Windows.Forms.Button Configure_Ldap;
	}
}